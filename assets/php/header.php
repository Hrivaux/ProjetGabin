...
<head>
  ...
  <title>Sellerie Personeni - Site internet</title>
  ...
  <link href="assets/vendor/bootstrap/css/bootstrap.min.css?1" rel="stylesheet">
  ...
  <div class="container d-flex align-items-center justify-content-between position-relative">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li><a class="nav-link scrollto" href="index.php#about">À propos de moi</a></li>
        ...
        <li><a class="nav-link scrollto" href="index.php#portfolio">Mes créations</a></li>
